...
Perform low level, realtime MIDI input and output in Ruby for Linux using the ALSA RawMIDI driver interface API.  
...
{Ari Russo}[http://github.com/arirusso] _ari(dot)russo(at)gmail(dot)com_
